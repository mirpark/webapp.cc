define([
	...
	'backbone', 
	'hogan',
	'text!templates/users-lookup.html'
	], 
	function($, Backbone, hogan, UsersLookupTemplate) {
	
	"use strict";
	
	var UsersLookupView = Backbone.View.extend({
		initialize: function() {
		...
		renderData: function() {
			if (this.collection.length >= 1) {
				var template = hogan.compile(UsersLookupTemplate);
